...
public class SandboxMapas
{
    ...
    public List<String> getValoresComoLista( )
    {
        ...
        valores.sort(String::compareTo); // Orden lexicográfico
        return valores;
    }
    ...
    public List<String> getLlavesComoListaInvertida( )
    {
        ...
        Collections.sort(llavesInvertidas, Collections.reverseOrder());
    ...
    public void reiniciarMapaCadenas( List<Object> objetos )
    {
        ...
        for (Object obj : objetos) {
            ...
            String llave = Integer.toHexString(System.identityHashCode(obj)); // Generar una llave única para cada objeto
            mapaCadenas.put(llave, cadena);
        }
    }
