...
public class SandboxConjuntos
{
    ...
    {
        NavigableSet<String> reverse = arbolCadenas.descendingSet();
        List<String> lista = new ArrayList<String>(reverse);
        return lista;        
    }
    ...
    {
        String primera = arbolCadenas.pollFirst();
        return primera;
    }
    ...
    {
        String ultima = arbolCadenas.pollLast();
        return ultima;
    }
    ...
    {
        Collection<String> siguientes = arbolCadenas.tailSet(cadena);
        return siguientes;
    }
    ...
    public void reiniciarConjuntoCadenas( List<Object> objetos )
    {
    	...
    	while (iterator.hasNext()) {
			...
			String cadenaObjeto = objeto.toString();
    ...
    {
    	NavigableSet<String> nuevoSet;
    	nuevoSet = new TreeSet<String>();
    	Iterator<String> iterator = arbolCadenas.iterator();
    	while (iterator.hasNext()) {
			String actual = (String) iterator.next();
    ...
    public boolean compararElementos( String[] otroArreglo )
    {
    	...
    	rta = arbolCadenas.equals(nuevoSet);
        return rta;
    }
